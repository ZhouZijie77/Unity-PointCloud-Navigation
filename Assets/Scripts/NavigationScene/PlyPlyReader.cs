...
public class PlyPlyReader
{
    // Start is called before the first frame update
    static Vector3[] Readply(string path)
    {
        try
        {
            ...
            Vector3[] vertices = body.vertices.ToArray();
            return vertices;
        }
        catch (Exception e)
        {
    ...
    static DataBody ReadDataBody(DataHeader header, BinaryReader reader)
    {
